...
void INT_MTU2_CMI1(void);
void INT_MTU23_CMI2(void);
void INT_MTU2_CMI3(void);
...
struct vtable_t {
  ...
  null_int,
  null_int,
  INT_MTU2_CMI3,			/* 120	MTU2_4 TGIA4 */
